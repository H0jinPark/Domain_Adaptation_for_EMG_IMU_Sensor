...
class samsung_da(object):
    def __init__(self):
        super(samsung_da, self).__init__()
        ...
        self.fourier_modes = 1200  # 300→1200: EMG 유효 주파수(20~450Hz) 중 ~240Hz까지 커버
        self.out_dim = self.fourier_modes * 2 + self.final_out_channels

"""No-DA baseline 학습 스크립트 (멀티모달 intermediate fusion, multi-seed 지원).
...
def train_no_da(seed=42, epochs=30, batch_size=64, lr=1e-3, save_cm=True):
    set_seed(seed)
    ...
    print("Mode: multimodal intermediate fusion, source-only, no domain adaptation")

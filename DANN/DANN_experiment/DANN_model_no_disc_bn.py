...
Feature extractor 의 BatchNorm 은 유지하되, domain discriminator 내부의 BatchNorm 은
제거한다. source/target 을 분리 forward 하는 AdaTime-style DANN 에서 discriminator 가
도메인별 batch statistics 에 의해 다시 정규화되는 현상을 줄이기 위한 비교 실험이다.
"""
import torch
...
class DANNModel(nn.Module):
    ...
    def __init__(self, in_channels=5, num_classes=10):
        ...
        # AdaTime-style 구현에 맞춰 discriminator 내부 BatchNorm 을 제거한다.
